...
import org.apache.hyracks.storage.am.vector.frames.VTreeFrameType;
...
public class LSMVTreeTestHarness {
    ...
    public static final VTreeFrameType[] LEAF_FRAMES_TO_TEST = new VTreeFrameType[] { VTreeFrameType.REGULAR_NSM };
    ...
    protected IVTreeDataTupleCreatorFactory dataTupleCreatorFactory;
    ...
    public LSMVTreeTestHarness() {
        ...
        this.dataTupleCreatorFactory = new QuantizedVTreeDataTupleCreatorFactory(0);
    }
    ...
    public IVTreeDataTupleCreatorFactory getDataTupleCreatorFactory() {
