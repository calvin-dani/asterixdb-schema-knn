 ...
 *   <li>DML delete ({@code VTreeDataTupleCreator#writeQuantizedFields}) duplicates the
 ...
 */
@AiProvenance(agent = AiProvenance.Agent.CLAUDE_FABLE_5, tool = AiProvenance.Tool.CLAUDE_CODE_UI, contributionKind = AiProvenance.ContributionKind.TEST_GENERATED, notes = "Red-green regression for quantized merge cancellation key including field 2")
public class LSMVTreeCompactQuantizedTest {
    ...
    public void compactCancelsDeletesDespiteQuantizedDistanceMismatch() throws Exception {
        ...
        try {
            ...
            // full-precision field 2 (VTreeDataTupleCreator duplicates field 0).
