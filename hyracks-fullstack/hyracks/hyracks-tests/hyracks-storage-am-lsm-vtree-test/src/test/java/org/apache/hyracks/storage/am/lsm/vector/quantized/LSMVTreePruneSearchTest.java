 ...
 */
public class LSMVTreePruneSearchTest extends QuantizedSearchTestDriver {
    ...
    protected void runTest(ISerializerDeserializer[] centroidSerdes, ISerializerDeserializer[] dataRecordSerdes,
        ...
        if (LOGGER.isInfoEnabled()) {
            LOGGER.info("LSMVTree Pruning Search Test: {} levels, {} centroids, {} leaf clusters, {}D vectors",
