...
public final class LSMVTreeTestContext extends AbstractVectorTreeTestContext {
    ...
    public static LSMVTreeTestContext create(NCConfig storageConfig, IIOManager ioManager,
            ...
            IVTreeDataTupleCreatorFactory dataTupleCreatorFactory) throws Exception {
    ...
    public static LSMVTreeTestContext create(NCConfig storageConfig, IIOManager ioManager,
            ...
            ILSMIOOperationCallbackFactory ioOpCallbackFactory, ILSMPageWriteCallbackFactory pageWriteCallbackFactory,
            IMetadataPageManagerFactory metadataPageManagerFactory,
            IVTreeDataTupleCreatorFactory dataTupleCreatorFactory, int numIncludeFields) throws Exception {
    ...
    public static LSMVTreeTestContext createWithQuantizedLeafFrame(NCConfig storageConfig, IIOManager ioManager,
            ...
            ILSMOperationTracker opTracker, ILSMIOOperationScheduler ioScheduler,
            ILSMIOOperationCallbackFactory ioOpCallbackFactory, ILSMPageWriteCallbackFactory pageWriteCallbackFactory,
            IMetadataPageManagerFactory metadataPageManagerFactory, float[] quantizationParams) throws Exception {
        ...
        IVTreeDataTupleCreatorFactory effectiveFactory = new VTreeDataTupleCreatorFactory(numIncludeFields, false);
        LSMVTree lsmVTree = LSMVTreeUtils.createLSMTree(storageConfig, ioManager, virtualBufferCaches, file,
                diskBufferCache, typeTraits, cmpFactories, 0.0, mergePolicy, opTracker, ioScheduler,
                ioOpCallbackFactory, pageWriteCallbackFactory, false, numVectorFields, new int[] { 0 }, (int[]) null,
                ...
                quantizationParams, "euclidean", TestVTreeDistanceFunctionFactory.INSTANCE);
