    ...
    public static LSMVTreeTestContext create(NCConfig storageConfig, IIOManager ioManager,
        ...
        if (dataTupleCreatorFactory != null || numIncludeFields > 0) {
            ...
            IVTreeDataTupleCreatorFactory effectiveFactory = dataTupleCreatorFactory != null ? dataTupleCreatorFactory
                    : new org.apache.hyracks.storage.am.vector.impls.VTreeDataTupleCreatorFactory(numIncludeFields);
        ...
        LSMVTreeTestContext testCtx = new LSMVTreeTestContext(fieldSerdes, lsmVTree, numVectorFields);
        return testCtx;
    }
}
