...
public class QuantizedIndexCreateOperatorDescriptor extends AbstractSingleActivityOperatorDescriptor {
    ...
    private static class QuantizedIndexCreateOperatorNodePushable extends AbstractUnaryInputSinkOperatorNodePushable {
        ...
        private Map<String, Object> extractQuantizationParams(FrameTupleReference tuple) throws HyracksDataException {
            ...
            try (DataInputStream in = new DataInputStream(
                ...
                params.put("minQuantile", in.readFloat());
                params.put("maxQuantile", in.readFloat());
                params.put("alpha", in.readFloat());
                params.put("bits", in.readInt());
                params.put("confidenceInterval", in.readFloat());
                params.put("sampleCount", in.readInt());
                return params;
            } catch (IOException e) {
