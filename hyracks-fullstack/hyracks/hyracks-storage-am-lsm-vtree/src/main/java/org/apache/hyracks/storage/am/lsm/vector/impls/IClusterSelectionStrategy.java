...
public interface IClusterSelectionStrategy {
     ...
     */
    default void setQuantizer(double[] quantizedQueryVector, IVTreeQuantizer quantizer) {
     ...
     */
    default void deferSeedCluster(ClusterSearchResult seed) {
        // No-op: full-scan strategies have no greedy seed to defer.
    }
