...
/**
 * Factory for creating VTree instances in LSM context.
 * 
 * This factory creates VTree instances that can be used
...
public class VTreeFactory extends TreeIndexFactory<VTree> {
    ...
    public VTreeFactory(IIOManager ioManager, IBufferCache bufferCache, IPageManagerFactory freePageManagerFactory,
            ...
            IVTreeBinaryAccessorFactory vectorAccessorFactory, IVTreeDataTupleCreatorFactory dataTupleCreatorFactory,
            float[] quantizationParams, String distanceMetric) {
    ...
    @Override
    public VTree createIndexInstance(FileReference file) {
        return new VTree(bufferCache, freePageManagerFactory.createPageManager(bufferCache), interiorFrameFactory,
                ...
                vectorDimensions, file, vectorAccessorFactory, dataTupleCreatorFactory, quantizationParams,
                distanceMetric);
    }
}
