...
public class LSMVTreeDiskComponent extends AbstractLSMDiskComponent {
     ...
     */
    @AiProvenance(agent = AiProvenance.Agent.CLAUDE_FABLE_5, tool = AiProvenance.Tool.CLAUDE_CODE_UI, contributionKind = AiProvenance.ContributionKind.ASSISTED, notes = "Fix: antimatter stripped on partial merge (delete resurrection)")
