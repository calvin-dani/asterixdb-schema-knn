 ...
 * Bit 0 of the null-flag byte is reserved for the antimatter (deletion) marker; user fields
 * occupy bits 1..N. Matter and anti-matter tuples share the same physical layout and size.
 */
