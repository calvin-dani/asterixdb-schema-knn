...
public class LSMVTreeDiskComponentLoader implements ILSMDiskComponentBulkLoader {
    private static final int CHECK_CYCLE = 1000;
    private VTreeFlushLoader flushLoader;
    ...
    public LSMVTreeDiskComponentLoader(ILSMIOOperation operation, ILSMDiskComponent diskComponent,
    ...
    public void setFlushLoader(VTreeFlushLoader flushLoader) {
