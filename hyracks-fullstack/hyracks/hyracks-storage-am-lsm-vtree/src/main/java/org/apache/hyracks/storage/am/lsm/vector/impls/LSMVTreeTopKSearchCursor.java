    ...
    public void close() throws HyracksDataException {
        if (isOpen) {
            if (LOGGER.isTraceEnabled()) {
                LOGGER.trace(
                        "Search summary: K={}, nprobe={}, epsilon={}, clustersExplored={}, tuplesProcessed={},"
                                + " antimatterCancellations={}, filteredOut={}, resultsReturned={}",
                        K, nprobe, epsilon, clustersExplored, totalTuplesProcessed, antimatterCancellations,
                        tuplesFilteredOut, nextCallCount);
            }
