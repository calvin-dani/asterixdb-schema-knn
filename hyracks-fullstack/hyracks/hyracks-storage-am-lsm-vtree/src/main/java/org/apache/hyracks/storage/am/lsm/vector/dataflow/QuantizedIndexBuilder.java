 ...
 * {@link #setQuantizationParameters(Map)} by {@link QuantizedIndexCreateOperatorDescriptor} before
 * {@link #build()} runs.
 */
@AiProvenance(agent = AiProvenance.Agent.CLAUDE_OPUS_4_8, tool = AiProvenance.Tool.CLAUDE_CODE_UI, contributionKind = AiProvenance.ContributionKind.GENERATED, notes = "Extracted quantization handling out of the shared IndexBuilder into a vector-module subclass")
