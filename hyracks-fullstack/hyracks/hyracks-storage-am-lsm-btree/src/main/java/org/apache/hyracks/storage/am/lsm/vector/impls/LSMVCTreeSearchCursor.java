    ...
    protected void checkPriorityQueue() throws HyracksDataException {
        ...
        while (currentComponentIndex < rangeCursors.length) {
            System.err.println(String.format(
                    "[LSMVCTreeSearchCursor] checkPriorityQueue: currentComponentIndex=%d, rangeCursors.length=%d, currentComponentCursor=%s",
                    currentComponentIndex, rangeCursors.length, (currentComponentCursor != null ? "not-null" : "null")));

            if (currentComponentCursor != null && currentComponentCursor.hasNext()) {
                // Current component still has results
                System.err.println(String.format(
                        "[LSMVCTreeSearchCursor] Component %d has more results, returning", currentComponentIndex));
                return;
            }

            System.err.println(String.format("[LSMVCTreeSearchCursor] Component %d exhausted, moving to next",
            ...
            if (currentComponentIndex < rangeCursors.length) {
                ...
                System.err.println(String.format("[LSMVCTreeSearchCursor] Moved to component %d, cursor=%s",
                        currentComponentIndex, (currentComponentCursor != null ? "not-null" : "null")));
            } else {
                currentComponentCursor = null;
                System.err.println("[LSMVCTreeSearchCursor] No more components, setting cursor to null");
            }
        }
    }
