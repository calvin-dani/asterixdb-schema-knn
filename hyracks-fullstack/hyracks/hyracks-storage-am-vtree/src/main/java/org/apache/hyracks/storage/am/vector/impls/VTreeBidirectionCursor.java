 ...
 *
 * Used by LSMVTreeBlockedCursor for optimized search with triangle inequality pruning.
 */
public class VTreeBidirectionCursor implements IIndexCursor {
    ...
    private IVTreeDataFrame rightDataFrame;
    ...
    private IVTreeDataFrame leftDataFrame;
    ...
    public void openCluster(long firstDirPageId, double dqc) throws HyracksDataException {
        ...
        while (dirPageId != -1) {
            ...
            IVTreeMetadataFrame dirFrame = createMetadataFrame();
    ...
    private void initializeCursorsAtPivot(int pivotEntryIndex, double dqc) throws HyracksDataException {
        ...
        VTreeDataFrame pivotFrame = (VTreeDataFrame) createDataFrame();
