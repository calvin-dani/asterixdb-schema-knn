...
public class VTreeSearchPredicate implements ISearchPredicate {
    ...
    public VTreeSearchPredicate(double[] queryVector) {
     ...
     * Kept for compatibility with VTreeSearchCursor.extractNprobe().
     */
    ...
    /**
     * Set the search approach (0=naive using LSMVTreeSearchCursor, 1=optimized using LSMVTreeBlockedCursor).
     */
    ...
    public String toString() {
        return "VTreeSearchPredicate[queryTuple=" + (queryTuple != null ? "set" : "null") + ", distanceMetric="
