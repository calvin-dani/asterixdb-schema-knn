...
public class VTreeMetadataFrame extends VTreeNSMFrame implements IVTreeMetadataFrame {
    ...
    public void initBuffer(byte level) {
        ...
        buf.putInt(getNextPageOffset(), -1);
    }

    @Override
    public int getPageHeaderSize() {
        return getNextPageOffset() + Integer.BYTES;
    }
    ...
    /**
     * Build a metadata tuple {@code <maxDistance:double, dataPageId:int>} suitable for insertion into this frame.
     */
