...
/**
 * Factory for creating {@link VTreeDataTupleCreator} instances.
 *
...
public class VTreeDataTupleCreatorFactory implements IVTreeDataTupleCreatorFactory {
    ...
    public VTreeDataTupleCreatorFactory(int numIncludeFields, boolean isQuantized) {
        this.numIncludeFields = numIncludeFields;
        this.isQuantized = isQuantized;
    }

    @Override
    public IVTreeDataTupleCreator createDataTupleCreator(float[] quantizationParams) {
        return new VTreeDataTupleCreator(numIncludeFields, isQuantized, quantizationParams);
    }
