...
public final class VTreeStaticTupleConstants {
    ...
    /** Input field count of an interior centroid tuple: {@code [cid, embedding]}. */
    public static final int INTERIOR_INPUT_FIELDS = 2;

    /** Input field count of a quantized leaf tuple: {@code [cid, embedding, quantizedBytes]}. */
    public static final int LEAF_QUANTIZED_INPUT_FIELDS = 3;

    /**
     * Input field count of a quantized leaf tuple with a graph-neighbor list:
     * {@code [cid, embedding, quantizedBytes, neighborList]}.
     */
    public static final int LEAF_QUANTIZED_NEIGHBORS_INPUT_FIELDS = 4;
}
