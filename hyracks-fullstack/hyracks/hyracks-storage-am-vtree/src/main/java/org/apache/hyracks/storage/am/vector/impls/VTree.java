...
public class VTree extends AbstractTreeIndex {
    ...
    public VTree(IBufferCache bufferCache, IPageManager freePageManager, ITreeIndexFrameFactory interiorFrameFactory,
            ...
            int vectorDimensions, FileReference file,
    ...
    private void upsertVector(ITupleReference tuple, VTreeOpContext ctx) throws HyracksDataException {
    ...
    public class VTreeAccessor implements ITreeIndexAccessor {
        ...
        public void reset(VTree vtree, IIndexAccessParameters iap) {
            this.tree = vtree;
            this.iap = iap;
         ...
         *
         * @return VTreeBidirectionCursor configured with tree navigation capabilities
         * @throws HyracksDataException if cursor creation fails
         */
        public VTreeBidirectionCursor createBidirectionCursor() throws HyracksDataException {
            VTreeBidirectionCursor cursor = new VTreeBidirectionCursor();
         ...
         * (VTreeNavigationUtils.findCloseCentroidsLevelWiseGlobalSort). Returns a list
