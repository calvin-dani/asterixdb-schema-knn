    ...
    public class VTreeAccessor implements ITreeIndexAccessor {
        ...
        public void search(IIndexCursor cursor, ISearchPredicate searchPred) throws HyracksDataException {
            ...
            IVTreeDistanceFunctionFactory distanceFunctionFactory = (IVTreeDistanceFunctionFactory) iap.getParameters()
                    .get(HyracksConstants.VECTOR_DISTANCE_FUNCTION_FACTORY);
            ...
            // IVTreeQuantizer may be injected directly under VECTOR_QUANTIZER (e.g.
            // NoOpVectorQuantizer.INSTANCE in VectorTreeTestUtils).
            ...
            if (qParams != null && queryVector != null && distanceMetric != null) {
                IVTreeQuantizerFactory quantizerFactory =
                        (IVTreeQuantizerFactory) iap.getParameters().get(HyracksConstants.VECTOR_QUANTIZER_FACTORY);
            ...
            // Fallback: a pre-built IVTreeQuantizer injected directly under VECTOR_QUANTIZER.
