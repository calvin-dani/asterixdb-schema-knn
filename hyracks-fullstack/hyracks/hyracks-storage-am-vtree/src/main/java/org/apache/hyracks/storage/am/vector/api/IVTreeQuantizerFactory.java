...
public interface IVTreeQuantizerFactory extends Serializable {
     ...
     * @param params           the {@code float[6]} scalar-quantization params
     *                         {@code {minQuantile, maxQuantile, alpha, confidenceInterval, bits,
     *                         sampleCount}} (same layout as
     *                         {@link IVTreeDataTupleCreatorFactory#createDataTupleCreator}); never
     *                         {@code null} on this path, which is only reached for a quantized index
