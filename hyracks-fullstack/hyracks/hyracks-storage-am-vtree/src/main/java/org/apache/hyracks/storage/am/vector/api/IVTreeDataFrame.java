...
public interface IVTreeDataFrame extends IVTreeFrame {
     ...
     * inserting {@code tuple} at {@code insertIndex} into whichever half keeps the ascending order.
     * On return both halves remain sorted by {@code distance_to_centroid}.
     */
    void split(IVTreeDataFrame rightFrame, ITupleReference tuple, int insertIndex) throws HyracksDataException;
