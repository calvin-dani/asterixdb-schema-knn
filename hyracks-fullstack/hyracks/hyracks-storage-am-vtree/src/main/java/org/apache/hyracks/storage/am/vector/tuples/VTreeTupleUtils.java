...
public class VTreeTupleUtils {
    /**
     * Deep-copies {@code source} into the storage backing {@code target}.
     *
     * @param source source tuple to copy from
     * @param target target reference; its field count and backing buffer are reset to the copy
