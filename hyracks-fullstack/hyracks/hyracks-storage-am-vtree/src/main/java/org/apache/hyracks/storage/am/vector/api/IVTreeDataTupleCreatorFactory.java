 ...
 * Serializable so it can be persisted with the index resource metadata.
 */
public interface IVTreeDataTupleCreatorFactory extends Serializable {
     ...
     *        ({minQuantile, maxQuantile, alpha, confidenceInterval, bits, sampleCount}),
     *        or null if quantization is not enabled
