...
public class VTreeOpContext implements IIndexOperationContext, IExtraPageBlockHelper {
    ...
    private final IVTreeDataTupleCreator dataTupleCreator;
    ...
    public VTreeOpContext(IIndexAccessor accessor, ITreeIndexFrameFactory interiorFrameFactory,
            ...
            IVTreeDataTupleCreatorFactory dataTupleCreatorFactory, float[] quantizationParams) {
        ...
        this.dataTupleCreator = dataTupleCreatorFactory.createDataTupleCreator(quantizationParams);
    ...
    public IVTreeDataTupleCreator getDataTupleCreator() {
