...
/**
 * Quantized data tuple creator for VTree.
 *
 * Includes quantized distance and quantized embedding in the data tuple so that
 * search cursors (e.g., LSMVTreeBlockedCursor) can compute approximate D(q, x)
 ...
 */
public class QuantizedVTreeDataTupleCreator implements IVTreeDataTupleCreator {
    ...
    public QuantizedVTreeDataTupleCreator(int numIncludeFields) {
