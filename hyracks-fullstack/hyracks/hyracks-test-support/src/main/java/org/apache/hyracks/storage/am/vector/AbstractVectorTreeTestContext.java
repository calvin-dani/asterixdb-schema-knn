...
public abstract class AbstractVectorTreeTestContext extends IndexTestContext<CheckTuple> {
    ...
    // Hyracks task context for IndexAccessParameters.HYRACKS_TASK_CONTEXT — required by
    // LSMVTreeTopKSearchCursor's SpillableTopKBuffer for frame allocation and disk spill.
    // Tests should populate this from their test harness via setHyracksTaskContext(...)
    // before exercising any search/insert/delete that opens a cursor through VectorTreeTestUtils.
