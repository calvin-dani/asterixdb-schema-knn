...
public class TestVTreeDistanceFunctionFactory implements IVTreeDistanceFunctionFactory {
    ...
    public static final TestVTreeDistanceFunctionFactory INSTANCE = new TestVTreeDistanceFunctionFactory();

    @Override
    public IVTreeDistanceFunction createDistanceFunction(String distanceMetric) {
        String metric = distanceMetric == null ? "euclidean" : distanceMetric.toLowerCase().trim();
        switch (metric) {
