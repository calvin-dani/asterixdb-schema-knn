...
public class VectorTreeTestUtils extends TreeIndexTestUtils {
    ...
    /**
     * Test optimized search using LSMVTreeBlockedCursor with bidirectional traversal
    ...
    public void optimizedSearch(AbstractVectorTreeTestContext ctx) throws Exception {
        ...
        // 3. Create accessor with IVTreeBinaryAccessorFactory in parameters
        // Also set USE_OPTIMIZED_SEARCH flag to enable LSMVTreeBlockedCursor
    ...
    /**
     * Test naive blocked search using LSMVTreeBlockedCursorNaive with sequential cluster scanning
     * and top-K window collection.
     *
     * This method mirrors optimizedSearch() but uses USE_NAIVE_BLOCKED_SEARCH flag
     * instead of USE_OPTIMIZED_SEARCH, which routes to LSMVTreeBlockedCursorNaive
     * (searchApproach=3) instead of LSMVTreeBlockedCursor (searchApproach=1).
     *
