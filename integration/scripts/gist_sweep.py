#!/usr/bin/env python3
"""Sweep nprobe x epsilon for GIST-960 euclidean on existing GistTest dataverse."""
...
def load_query_vector():
    ...
    path = os.path.join(base_dir, "datasets", "gist-960-euclidean_train.jsonl")
    with open(path) as f:
...
def main():
    ...
    # Print summary table
    print(f"\n{'='*60}")
    print(f"  SUMMARY: GIST-960 Euclidean Recall@{K}")
    print(f"{'='*60}")
