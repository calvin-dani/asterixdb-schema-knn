...
public class TransformerTest extends AbstractDummyTest {
    ...
    public void runTest() throws IOException {
        ...
        ObjectRowSchemaNode node = transform();
        writeResult(node);
        testCase.compare();
    }

    private void writeResult(ObjectRowSchemaNode root) throws IOException {
        File resultFile = testCase.getOutputFile();
        RowSchemaStringBuilderVisitor schemaBuilder = new RowSchemaStringBuilderVisitor(columnMetadata.getFieldNamesDictionary());
