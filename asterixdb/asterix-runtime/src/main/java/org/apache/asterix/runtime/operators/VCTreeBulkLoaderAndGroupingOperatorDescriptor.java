...
public class VCTreeBulkLoaderAndGroupingOperatorDescriptor extends AbstractSingleActivityOperatorDescriptor {
    ...
    /**
     * Convert DistanceFunction to IVTreeDistanceFunction for use in Hyracks modules.
     *
     * @param distanceFunction AsterixDB DistanceFunction
     * @return IVTreeDistanceFunction wrapper
     */
    private static IVTreeDistanceFunction wrapDistanceFunction(DistanceFunction distanceFunction) {
        ...
        private OptimizedScalarQuantizationSampleFile.Params readQuantizationParamsFromMetadata(
            ...
            try {
                ...
                if (resource instanceof DatasetLocalResource) {
                    ...
                    System.err.println("READ: Resource is direct LSMVTreeLocalResource (not wrapped)");
                } else {
                    System.err.println(
                ...
                if (vcResource == null) {
                    System.err.println(
                            "READ: WARNING - LSMVTreeLocalResource not found, using default quantization params");
                    return createDefaultQuantizationParams(vectorDimension);
                }
