    ...
    public IScalarEvaluatorFactory createEvaluatorFactory(final IScalarEvaluatorFactory[] args) {
        return new IScalarEvaluatorFactory() {
            ...
            public IScalarEvaluator createScalarEvaluator(IEvaluatorContext ctx) throws HyracksDataException {
                DistanceFunction distanceFunction = resolveDistanceFunction(ctx, args);
                return new VectorDistanceArrScalarEvaluator(ctx, args, getIdentifier(), distanceFunction, sourceLoc);
            }

        };
    }

    private DistanceFunction resolveDistanceFunction(IEvaluatorContext ctx, IScalarEvaluatorFactory[] args)
        ...
        DistanceFunction distanceFunction = DISTANCE_MAP.get(metricHash);
