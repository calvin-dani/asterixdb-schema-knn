...
public class ANNDistanceDescriptor extends AbstractScalarFunctionDynamicDescriptor {
    ...
    private static final Map<Integer, ToDoubleBiFunction<double[], double[]>> DISTANCE_MAP =
            Map.of(EUCLIDEAN_DISTANCE.hash(), VectorDistanceCalculation::euclidean, EUCLIDEAN_DISTANCE_L2.hash(),
                    VectorDistanceCalculation::euclidean, EUCLIDEAN_DISTANCE_SQUARED.hash(),
                    VectorDistanceCalculation::euclideanSquared, EUCLIDEAN_DISTANCE_L2_SQUARED.hash(),
                    VectorDistanceCalculation::euclideanSquared, COSINE_DISTANCE.hash(),
                    VectorDistanceCalculation::cosineDistance, COSINE_SIMILARITY.hash(),
                    VectorDistanceCalculation::cosineDistance, DOT_DISTANCE.hash(),
                    (a, b) -> -VectorDistanceCalculation.dotProduct(a, b));
