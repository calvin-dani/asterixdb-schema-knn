    ...
    protected class FindCandidatesActivity extends AbstractActivityNode {
        ...
        public IOperatorNodePushable createPushRuntime(final IHyracksTaskContext ctx,
            ...
            return new AbstractUnaryOutputSourceOperatorNodePushable() {
                 ...
                 */
                @AiProvenance(agent = AiProvenance.Agent.CLAUDE_FABLE_5, tool = AiProvenance.Tool.CLAUDE_CODE_UI, contributionKind = AiProvenance.ContributionKind.ASSISTED, notes = "Open-fd leak fix: single-owner tracking of the live sample reader")
                 ...
                 */
                @AiProvenance(agent = AiProvenance.Agent.CLAUDE_FABLE_5, tool = AiProvenance.Tool.CLAUDE_CODE_UI, contributionKind = AiProvenance.ContributionKind.ASSISTED, notes = "Close the superseded reader before opening a new one (open-fd leak fix)")
                ...
                @AiProvenance(agent = AiProvenance.Agent.CLAUDE_FABLE_5, tool = AiProvenance.Tool.CLAUDE_CODE_UI, contributionKind = AiProvenance.ContributionKind.ASSISTED, notes = "Part of the open-fd leak fix: idempotent close of the tracked live reader")
