...
public final class HierarchicalKMeansPlusPlusCentroidsOperatorDescriptor extends AbstractOperatorDescriptor {
    ...
    static class HierarchicalClusterStructure {
        ...
        /**
         * Computes the modal leaf depth for top-down structures where level 0 is root and larger
         * level values are deeper in the tree. A leaf is a centroid index at level L that is not
         * referenced as parentClusterId by any centroid at level L + 1.
         */
        public int computeModalLeafDepth() {
            ...
            for (Map.Entry<Integer, Integer> entry : leafDepthHistogram.entrySet()) {
                ...
                // Tie-break toward the deeper level to preserve more of the built structure.
    ...
    // Historical internal cap constant; effective runtime cap is configured via maxLevel.
    ...
    private static final Logger LOGGER = LogManager.getLogger();
    // Default for WITH/COMPILER top-down max level. Level numbering starts at 0 (root).
