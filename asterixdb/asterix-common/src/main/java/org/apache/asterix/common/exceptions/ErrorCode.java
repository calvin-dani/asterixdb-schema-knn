...
public enum ErrorCode implements IError {
    ...
    ESTIMATED_COLUMN_COUNT_NOT_APPLICABLE_TO_TYPE(1243),
    CANNOT_CREATE_VECTOR_IDX_ON_MULTIPLE_FIELDS(1244),
    ESTIMATED_COLUMN_COUNT_NOT_APPLICABLE_TO_TYPE(1245),
    CANNOT_CREATE_VECTOR_IDX_ON_MULTIPLE_FIELDS(1246),
