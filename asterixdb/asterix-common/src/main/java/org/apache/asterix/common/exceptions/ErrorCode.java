...
public enum ErrorCode implements IError {
    ...
    INVALID_FULL_SCAN_OPTION(1243),
    COMPILATION_ANN_DISTANCE_METRIC_MISMATCH(1248),
    COMPILATION_VECTOR_INDEX_SIMILARITY_REQUIRED(1249),
    COMPILATION_VECTOR_INDEX_SIMILARITY_UNSUPPORTED(1250),
    COMPILATION_VECTOR_INDEX_QUANTIZATION_UNSUPPORTED(1251),
    COMPILATION_VECTOR_INDEX_TRAIN_LIST_UNSPECIFIED(1252),
    COMPILATION_VECTOR_INDEX_DIMENSION_REQUIRED(1253),
    COMPILATION_VECTOR_INDEX_TRAIN_LIST_FRACTION_RANGE(1254),
    COMPILATION_VECTOR_INDEX_TRAIN_LIST_CONFLICT(1255),
    COMPILATION_VECTOR_INDEX_EPSILON_RANGE(1256),
