...
public enum ErrorCode implements IError {
    ...
    COMPILATION_VECTOR_INDEX_SIMILARITY_REQUIRED(1258),
    COMPILATION_VECTOR_INDEX_SIMILARITY_UNSUPPORTED(1259),
    COMPILATION_VECTOR_INDEX_QUANTIZATION_UNSUPPORTED(1260),
    COMPILATION_VECTOR_INDEX_DIMENSION_REQUIRED(1261),
    COMPILATION_VECTOR_INDEX_TRAIN_LIST_FRACTION_RANGE(1262),
    COMPILATION_VECTOR_INDEX_DIMENSION_INVALID(1263),
    COMPILATION_VECTOR_INDEX_EPSILON_RANGE(1264),
    COMPILATION_VECTOR_INDEX_UNKNOWN_WITH_FIELD(1265),
