...
public class SqlppCompilationProvider implements ILangCompilationProvider {
    ...
    public Set<String> getCompilerOptions() {
        return new HashSet<>(Set.of(CompilerProperties.COMPILER_JOINMEMORY_KEY,
                ...
                CompilerProperties.COMPILER_VECTOR_PRUNEDSEARCH_KEY, CompilerProperties.COMPILER_VECTOR_KMULTIPLIER_KEY,
                CompilerProperties.COMPILER_VECTOR_TOPDOWN_V_KEY, CompilerProperties.COMPILER_VECTOR_TOPDOWN_GAMMA_KEY,
                CompilerProperties.COMPILER_VECTOR_TOPDOWN_LAMBDA_FACTOR_KEY,
                CompilerProperties.COMPILER_VECTOR_TOPDOWN_MAXLEVEL_KEY,
                CompilerProperties.COMPILER_VECTOR_SELECTHEAD_ENABLED_KEY,
                CompilerProperties.COMPILER_VECTOR_SELECTHEAD_HEAD_RATIO_KEY,
                CompilerProperties.COMPILER_VECTOR_SELECTHEAD_HEAD_COUNT_KEY,
                CompilerProperties.COMPILER_VECTOR_SELECTHEAD_SELECT_TYPE_KEY,
                CompilerProperties.COMPILER_VECTOR_VTREE_PRINT_TREE_ON_BUILD_KEY,
                CompilerProperties.COMPILER_VECTOR_VTREE_PRINT_TREE_ON_SEARCH_KEY, FuzzyUtils.SIM_FUNCTION_PROP_NAME,
