 ...
 *   [5] = search_approach         (0 for ann_distance, 4 for vector_distance)
 */
public class VectorJobGenParams extends AccessMethodJobGenParams {
    ...
    public void writeToFuncArgs(List<Mutable<ILogicalExpression>> funcArgs) {
        ...
        funcArgs.add(new org.apache.commons.lang3.mutable.MutableObject<>(
                AccessMethodUtils.createBooleanConstant(indexOnly)));
