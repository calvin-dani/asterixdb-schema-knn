...
public class InternalDatasetDetails implements IDatasetDetails {
    ...
    private final boolean randomSamplable;
    ...
    public static final String RANDOM_SAMPLABLE_FIELD_NAME = "RandomSamplable";
    ...
    public InternalDatasetDetails(FileStructure fileStructure, PartitioningStrategy partitioningStrategy,
            ...
            boolean isDatasetWithoutTypeSpecification, boolean randomSamplable) {
        ...
        this.randomSamplable = randomSamplable;
    }
    ...
    public InternalDatasetDetails(FileStructure fileStructure, PartitioningStrategy partitioningStrategy,
        ...
        this(fileStructure, partitioningStrategy, partitioningKey, primaryKey, keyFieldIndicators, primaryKeyType,
                autogenerated, filterSourceIndicator, filterField, false, true);
    }
    ...
    public boolean isRandomSamplable() {
        return randomSamplable;
    }
    ...
    public void writeDatasetDetailsRecordType(DataOutput out, DatasetEntity datasetEntity) throws HyracksDataException {
        ...
        // Serialize randomSamplable flag (only when true, to keep backward compatibility)
        if (randomSamplable) {
            ArrayBackedValueStorage nameValue = new ArrayBackedValueStorage();
            nameValue.reset();
            aString.setValue(RANDOM_SAMPLABLE_FIELD_NAME);
            stringSerde.serialize(aString, nameValue.getDataOutput());
            fieldValue.reset();
