        ...
        switch (dataset.getDatasetType()) {
            ...
            case INTERNAL:
                ...
                return new LSMBTreeLocalResourceFactory(storageManager, typeTraits, cmpFactories, filterTypeTraits,
                        ...
                        thetaSketchK, maxSampleLeafAttempts, index.isPrimaryIndex(), btreeFields, compDecompFactory,
                        false, typeTraitProvider.getTypeTrait(BuiltinType.ANULL), NullIntrospector.INSTANCE, false,
                        dataset.isAtomic());
            default:
